...
Issue:               https://github.com/kaushikhazra/axiom/issues/73
...
**Issue #72's loop edits the same function.** Read the current source before editing rather
than assuming it matches the last log, and never revert the other loop's change.
