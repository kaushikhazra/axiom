...
Fail-safe: at 2026-08-24 03:17 IST, stop and delete the cron, converged or not,
...
`src/` does not exist at the start, so cycle 1 writes. From cycle 2 on the loop **edits** what is there; it never regenerates it.

**First run: 2026-08-24 00:17 IST. Fail-safe deadline: 2026-08-24 03:17 IST.**
