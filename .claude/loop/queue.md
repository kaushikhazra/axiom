...
| 14 | [#61](https://github.com/kaushikhazra/axiom/issues/61) what the tools cost | `61-tool-cost` | **running** - started 2026-08-28 01:43 IST, fail-safe 05:43 IST, 12 criteria |
...
**Row 14 is running. Every row through 16 runs, one after another, until the queue is empty.**
